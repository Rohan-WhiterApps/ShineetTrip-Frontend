...
const rooms: Room[] = [
  {
    ...
    guests: 3,
    sqft: 200,
    description: "The 12 Standard Rooms in Shimla have a state-of-the-art design, curated to serve the modern traveler.",
    images: [
    ...
    <div className="bg-white mb-8">
      <div className="grid grid-cols-1 lg:grid-cols-[200px_1fr_auto] gap-6 mb-6">
        ...
        <div className="space-y-2">
          ...
          <a href="#" className="text-orange-500 text-sm hover:underline inline-block">
            more info
          </a>
        </div>
        ...
        <div className="text-right space-y-0.5">
          <p className="text-sm text-gray-400 line-through">
            INR {room.originalPrice.toLocaleString()}
          </p>
          <p className="text-3xl font-semibold text-green-600">
            INR {room.discountedPrice.toLocaleString()}
          </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {room.options.map((option, idx) => (
          <div 
            key={idx} 
            className="border-2 border-orange-400 rounded-md p-4 space-y-3"
          >
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-1.5">
                ...
                <span className="text-xs text-gray-700">
                  Save INR {option.savingAmount.toLocaleString()}/-
                </span>
              </div>
            ...
            <div className="space-y-0.5 pt-1">
              <p className="text-xs text-gray-400 line-through">
                INR {option.originalPrice.toLocaleString()}
              </p>
