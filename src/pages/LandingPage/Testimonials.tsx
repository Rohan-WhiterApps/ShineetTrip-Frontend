...
export default function Testimonials() {
  return (
    <section className="py-16 bg-[#2C3C3C]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-gray-300 text-[15px] max-w-2xl mx-auto leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {testimonials.map((testimonial) => (
            ...
            >
              {/* Background Number */}
              <div className="absolute top-4 right-6 text-[#4A5E5E] text-[120px] font-bold leading-none pointer-events-none opacity-50">
                {testimonial.number}
              </div>
              ...
              <div className="bg-[#8B7355] border border-[#A5865F] px-4 py-2 inline-block mb-6 relative z-10 rounded-sm">
                <p className="text-[#D4A76A] text-[11px] font-semibold tracking-[0.15em]">
                  {testimonial.package}
                </p>
              </div>

              {/* Testimonial Text */}
              <p className="text-gray-300 mb-8 leading-relaxed relative z-10 text-[14px]">
                "{testimonial.content}"
              </p>
